...
def create_polished_notebook():
    ...
    cells = [
        ...
        nbf.v4.new_markdown_cell("## 3. Part 2: EDA\nVisualizing data distributions and correlations."),
        nbf.v4.new_code_cell(
            ...
            "axes[0].set_title('Distribution of Total Food Demand')\n"
        ...
        nbf.v4.new_code_cell(
            ...
            "# IMPROVEMENT 1: Hyperparameter Tuning for Gradient Boosting\n"
            "gb_params = {\n"
    ...
    nb.cells = cells
    with open('Vector_Team_Final_Project.ipynb', 'w', encoding='utf-8') as f:
        nbf.write(nb, f)
    print("Polished notebook generated: Vector_Team_Final_Project.ipynb")

if __name__ == "__main__":
    create_polished_notebook()
